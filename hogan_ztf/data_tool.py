...
model_name = '/root/.cache/huggingface/hub/models--hfl--chinese-bert-wwm-ext/snapshots/2a995a880017c60e4683869e817130d8af548486/'
...
def get_label_idx(label_child_hieraset):
    ...
    sorted_label_idx  = {}
    idx = 0
    for key in sorted(label_idx.keys()):
        sorted_label_idx[key] = idx
        idx += 1
    return sorted_label_idx
